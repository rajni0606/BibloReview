...
public class FIrstActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonreviewone = findViewById(R.id.btnr1);
        buttonreviewone.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent RIntent = new Intent(getApplicationContext(), SureActivity.class);
